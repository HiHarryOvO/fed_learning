...
class Client(BaseModel):
    ...
    def train(self):
        ...
        self.mal_model.compile(loss=self.custom_loss(), optimizer=self.sgd_temp, metrics=["accuracy"])
...
for i in range(num_clients):
    ...
    dict_clients[ind].y_aux = keras.utils.to_categorical(y_aux_false_uncat[range(i * num_aux, (i + 1) * num_aux)], num_classes)
